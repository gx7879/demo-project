...
<template>
  <div class="max-w-[720px] mx-auto pt-[100px] pb-40 px-6">
    <div class="max-w-[460px] mx-auto">
      ...
      <button
        @click="reSend"
        class="text-white bg-main-black/80 font-bold rounded-[5px] text-lg w-full p-3 mb-[55px] disabled:border-main-black/80 disabled:border disabled:text-main-black/20 disabled:bg-transparent"
        :disabled="btnStatus"
      >
        {{ btnText }}
      </button>
